  ...
  return (
    ...
    >
      ...
      <div className='fv-row mb-8'>
        <label className='form-label fs-6 fw-bolder text-dark'>{intl.formatMessage({id: 'LOGIN_PAGE.E_MAIL'})}</label>
        <input
      ...
      <div className='fv-row mb-3'>
        <label className='form-label fw-bolder text-dark fs-6 mb-0'>{intl.formatMessage({id: 'LOGIN_PAGE.PASSWORD'})}</label>
        <input
          type='password'
          autoComplete='off'
      ...
      <div className='d-grid mb-10'>
        ...
        >
          {!loading && <span className='indicator-label'>{intl.formatMessage({id: 'LOGIN_PAGE.SUBMIT'})}</span>}
          {loading && (
